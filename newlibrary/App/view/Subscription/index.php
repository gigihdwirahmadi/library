    ...
    <table class="table">
        ...
        foreach ($data as $row) { ?>
            <tr>
                ...
                <td><a href="<?= newlibrary\app\core\Router::Url("/public/updatesubscription/$row->id") ?>" class="btn btn-success">update</a></td>
                <td><form action="<?= newlibrary\app\core\Router::Url("/public/deletesubscription") ?>" method="post">
